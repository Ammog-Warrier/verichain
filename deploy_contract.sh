...
./network.sh deployCC -c verichain-channel -ccn verichain-contract -ccp ./chaincode/src -ccl javascript -ccep "AND('Org1MSP.peer','Org2MSP.peer')" -ccs 1 -cccg ./collections_config.json
