...
function DistributorView() {
    ...
    const handleSimulate = async () => {
        ...
        try {
            console.log('Simulating IoT temperature readings:', batchId);
    ...
    return (
        <div className="card">
            ...
            {temperatureData.length > 0 && (
                <div style={{ marginBottom: '1.5rem' }}>
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1rem' }}>
                        <h3 style={{ fontSize: '1rem', fontWeight: 600 }}>Temperature Monitoring</h3>
            ...
            {stats?.inRange && !proofResult && (
                <div style={{ textAlign: 'center', padding: '1.5rem', background: 'var(--color-bg)', borderRadius: 'var(--radius)', marginBottom: '1rem' }}>
                    <button
        ...
        return (
            <div className="page">
                <div className="container">
                    <div className="card">
                        <h2>Access Denied</h2>
                        <p>Use Retailer Terminal to verify shipments.</p>
